...
export default async function Home() {
  ...
  //   const res = await fetch(`http://localhost:8000/chiefEditor`, {
  //     cache: "force-cache",
  //   });
  //   return res.json();
  // }
  ...
  //   const res = await fetch(`http://localhost:8000/titls`, {
  //     cache: "force-cache",
  //   });
  //   return res.json();
  // }
  // async function importantNew() {
  //   const res = await fetch(`http://localhost:8000/importNew`, {
  //     cache: "force-cache",
  //   });
  //   return res.json();
  // }
